...
This repository contains launch files to easily integrate your DIY robot with Nav2 and a simulation pipeline to run and verify your experiments on a virtual robo
...
Install linorobot2 package on the host machine:
    ...
    cd <host_machine_ws>
    git clone -b $ROS_DISTRO https://github.com/vedansh-k/Autonomous_Agricultural_Bot src/Autonomous_Agricultural_Bot
